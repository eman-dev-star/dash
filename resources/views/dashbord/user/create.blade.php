          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <div class="box-body">
                ...
                <form action="{{route('dashbord.user.store')}}" method="post" enctype="multipart/form-data">
                  @CSRF
                  @method('POST')
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <img src="{{asset('uploads/users/one.png')}}" width="100px" class="img-thubnail img-preview">
                </div>
                <div class="form-group">
